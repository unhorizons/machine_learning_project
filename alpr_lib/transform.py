...
class ImageTransformation:
    ...
    def rotate_image(self):
        ...
        2、 Arbitrary angle rotation function , Need to rotate the matrix M, 
        There are two ways to get the rotation matrix M The way ： 
        Manual configuration （ It can realize the rotating image without clipping ） And built-in functions to get 
